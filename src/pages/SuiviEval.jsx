...
import { Target, Award, BarChart3, Calendar, Upload, X, File, Paperclip, CheckCircle, AlertCircle } from 'lucide-react';
import { seApi } from '../api.js';
import HeroBanner from '../components/HeroBanner.jsx';
import { Card, Badge, ProgressBar, Btn, Select, Spinner, ErrorBanner } from '../components/UI.jsx';
...
const REV_TYPE = { mensuelle:{color:T.teal,label:'Mensuelle'}, trimestrielle:{color:'#8b5cf6',label:'Trimestrielle'}, annuelle:{color:'#f59e0b',label:'Annuelle'} };

const FT = { pdf:{color:'#ef4444',label:'PDF'}, word:{color:'#3b82f6',label:'Word'}, excel:{color:'#10b981',label:'Excel'}, ppt:{color:'#f97316',label:'PPT'}, default:{color:T.textDim,label:'Doc'} };
...
export default function SuiviEval() {
  ...
  const tabs = [{ id:'overview', icon:BarChart3, label:"Vue d'ensemble" }, { id:'indicateurs', icon:Target, label:'Indicateurs NDT' }, { id:'revues', icon:Calendar, label:'Revues & COPIL' }, { id:'evaluations', icon:Award, label:'Évaluations' }];
